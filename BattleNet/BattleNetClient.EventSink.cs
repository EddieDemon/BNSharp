...
namespace BNSharp.BattleNet
{
    partial class BattleNetClient
    {
        private class EventSink : IBattleNetEvents
        {
            ...
            // NOTE: Notifies the user that there's no email address set at the BNet server.
            public void OnSetMailRequest(SetMailRequestEventArgs e)
            {
                m_host.OnSetMailRequest(e);
            }
